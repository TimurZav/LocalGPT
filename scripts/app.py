...
class LocalGPT:
    def __init__(self):
        ...
        self.system_prompt: str = self._get_default_system_prompt(self.mode)
        self._queue = 0
    ...
    def _set_current_mode(self, mode: str) -> gr.update:
        """
        Setting prompt.
        :param mode: Mode.
        :return:
