...
QUERY_SYSTEM_PROMPT: str = "Вы, Макар - полезный, уважительный и честный ассистент. " \
                     ...
                     "Отвечайте на вопросы на русском языке, и ссылаясь на контекст."

LLM_SYSTEM_PROMPT: str = "Вы, Макар - полезный, уважительный и честный ассистент. Отвечай на русском языке"
